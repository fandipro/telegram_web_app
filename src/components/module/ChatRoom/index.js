...
const ChatRoom = ({
    activeReceiver, listChat, login, avatar, setListChat,
    socketio, chat, setChat, Swal
        ...
        <div className="col-12 col-lg-7 col-xl-9 main-chat">
            {activeReceiver.username ? (
                    ...
                    <div className="d-flex align-items-center py-1">
                        <div className="position-relative">
                            {activeReceiver.photo ? (
                                <img alt="" src={`${process.env.REACT_APP_API_URL}/${activeReceiver.photo}`} style={{ marginRight: "10px", borderRadius: "10px" }} width="40" height="40" />
                            ) : (
                                <img alt="" src={`${process.env.REACT_APP_API_URL}/user.png`} style={{ marginRight: "10px", borderRadius: "10px" }} width="40" height="40" />
                            )}
                        </div>
                ...
                <div className="py-2 px-4 d-none d-lg-block header-chat">
                    <div style={{ height: "55px" }} className="d-flex align-items-center py-1"></div>
                </div>
            )}
